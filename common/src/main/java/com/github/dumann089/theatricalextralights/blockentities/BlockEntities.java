...
public class BlockEntities {
    ...
    public static final RegistrySupplier<BlockEntityType<LaserProjectorBlockEntity>> LASER_PROJECTOR = BLOCK_ENTITIES.register("laser_projector", () -> BlockEntityType.Builder.of(LaserProjectorBlockEntity::new, Blocks.LASER_PROJECTOR_BLOCK.get()).build(null));
